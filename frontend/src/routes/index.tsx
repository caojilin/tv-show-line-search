...
const Business_TheTBBTSearch_Page = lazy(
  () => import(/* webpackChunkName: "with-aside" */ '@/pages/business/the-TBBT-search'),
);
const Business_TheOfficeTable_Page = lazy(
  () => import(/* webpackChunkName: "with-aside" */ '@/pages/business/the-office-lines-table'),
);
const Business_TheTBBTTable_Page = lazy(
  () => import(/* webpackChunkName: "with-aside" */ '@/pages/business/the-TBBT-lines-table'),
);
...
const routeList: RouteObject[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'business/the-TBBT-search',
        element: <WrapperRouteComponent element={<Business_TheTBBTSearch_Page />} titleId="title.account" />,
      },
      {
      ...
      {
        path: 'business/the-TBBT-lines-table',
        element: <WrapperRouteComponent element={<Business_TheTBBTTable_Page />} titleId="title.account" />,
      },
      {
